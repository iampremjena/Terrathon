...
// ============================================================================
// 1. EXACTLY 208 WORLD NATIONS (Compressed to save space)
// ============================================================================
const RAW_208_DATA = [
...
// ============================================================================
// 2. EXACTLY 500 MAPGUESSR LOCATIONS (50 Base * 10 Procedural Grid Offsets)
// ============================================================================
const BASE_50_PHOTOS = [
  { n: "Eiffel Tower", c: "France", i: "https://upload.wikimedia.org/wikipedia/commons/8/85/Tour_Eiffel_Wikimedia_Commons_%28cropped%29.jpg", lat: 48.8584, lng: 2.2945 },
  { n: "Taj Mahal", c: "India", i: "https://upload.wikimedia.org/wikipedia/commons/b/bd/Taj_Mahal%2C_Agra%2C_India_edit3.jpg", lat: 27.1751, lng: 78.0421 },
  { n: "Statue of Liberty", c: "United States", i: "https://upload.wikimedia.org/wikipedia/commons/a/a1/Statue_of_Liberty_7.jpg", lat: 40.6892, lng: -74.0445 },
  { n: "Sydney Opera House", c: "Australia", i: "https://upload.wikimedia.org/wikipedia/commons/7/7c/Sydney_Opera_House_-_Dec_2008.jpg", lat: -33.8568, lng: 151.2153 },
  { n: "Machu Picchu", c: "Peru", i: "https://upload.wikimedia.org/wikipedia/commons/e/eb/Machu_Picchu%2C_Peru.jpg", lat: -13.1631, lng: -72.5450 },
  { n: "Colosseum", c: "Italy", i: "https://upload.wikimedia.org/wikipedia/commons/d/de/Colosseo_2020.jpg", lat: 41.8902, lng: 12.4922 },
  { n: "Christ the Redeemer", c: "Brazil", i: "https://upload.wikimedia.org/wikipedia/commons/4/4f/Christ_the_Redeemer_-_Cristo_Redentor.jpg", lat: -22.9519, lng: -43.2105 },
  { n: "Great Wall of China", c: "China", i: "https://upload.wikimedia.org/wikipedia/commons/2/23/The_Great_Wall_of_China_at_Jinshanling-edit.jpg", lat: 40.4319, lng: 116.5704 },
  { n: "Pyramids of Giza", c: "Egypt", i: "https://upload.wikimedia.org/wikipedia/commons/a/af/All_Gizah_Pyramids.jpg", lat: 29.9792, lng: 31.1342 },
  { n: "Big Ben", c: "United Kingdom", i: "https://upload.wikimedia.org/wikipedia/commons/9/93/Clock_Tower_-_Palace_of_Westminster%2C_London_-_May_2007.jpg", lat: 51.5007, lng: -0.1246 },
  { n: "CN Tower", c: "Canada", i: "https://upload.wikimedia.org/wikipedia/commons/f/f6/CN_Tower_at_night.jpg", lat: 43.6426, lng: -79.3871 },
  { n: "Burj Khalifa", c: "UAE", i: "https://upload.wikimedia.org/wikipedia/commons/9/97/Burj_Khalifa_-_panoramio_%283%29.jpg", lat: 25.1972, lng: 55.2744 },
  { n: "Mount Fuji", c: "Japan", i: "https://upload.wikimedia.org/wikipedia/commons/1/1b/080103_hakkai_fuji.jpg", lat: 35.3606, lng: 138.7274 },
  { n: "Angkor Wat", c: "Cambodia", i: "https://upload.wikimedia.org/wikipedia/commons/4/41/Angkor_Wat.jpg", lat: 13.4125, lng: 103.8670 },
  { n: "Petra", c: "Jordan", i: "https://upload.wikimedia.org/wikipedia/commons/2/2f/Treasury_petra_crop.jpeg", lat: 30.3285, lng: 35.4444 },
  { n: "Table Mountain", c: "South Africa", i: "https://upload.wikimedia.org/wikipedia/commons/b/b0/Table_Mountain_Cape_Town_South_Africa.jpg", lat: -33.9628, lng: 18.4098 },
  { n: "Acropolis", c: "Greece", i: "https://upload.wikimedia.org/wikipedia/commons/a/a7/Parthenon_from_west.jpg", lat: 37.9715, lng: 23.7257 },
  { n: "Chichen Itza", c: "Mexico", i: "https://upload.wikimedia.org/wikipedia/commons/5/51/Chichen_Itza_3.jpg", lat: 20.6843, lng: -88.5678 },
  { n: "Niagara Falls", c: "Canada/USA", i: "https://upload.wikimedia.org/wikipedia/commons/1/1b/Niagara_Falls_viewed_from_Skylon_Tower.jpg", lat: 43.0962, lng: -79.0377 },
  { n: "Golden Gate Bridge", c: "United States", i: "https://upload.wikimedia.org/wikipedia/commons/0/0c/GoldenGateBridge-001.jpg", lat: 37.8199, lng: -122.4783 },
  { n: "Stonehenge", c: "United Kingdom", i: "https://upload.wikimedia.org/wikipedia/commons/3/3c/Stonehenge2007_07_30.jpg", lat: 51.1789, lng: -1.8262 },
  { n: "Mount Everest", c: "Nepal", i: "https://upload.wikimedia.org/wikipedia/commons/f/f6/Everest_kalapatthar.jpg", lat: 27.9881, lng: 86.9250 },
  { n: "Grand Canyon", c: "United States", i: "https://upload.wikimedia.org/wikipedia/commons/a/aa/Dawn_on_the_S_rim_of_the_Grand_Canyon_%288645178272%29.jpg", lat: 36.1069, lng: -112.1129 },
  { n: "Victoria Falls", c: "Zambia", i: "https://upload.wikimedia.org/wikipedia/commons/c/c7/Victoria_Falls_03.jpg", lat: -17.9244, lng: 25.8572 },
  { n: "Sagrada Familia", c: "Spain", i: "https://upload.wikimedia.org/wikipedia/commons/e/ee/Sagrada_Familia_01.jpg", lat: 41.4036, lng: 2.1744 },
  { n: "Neuschwanstein", c: "Germany", i: "https://upload.wikimedia.org/wikipedia/commons/f/f8/Schloss_Neuschwanstein_2013.jpg", lat: 47.5576, lng: 10.7498 },
  { n: "Kremlin", c: "Russia", i: "https://upload.wikimedia.org/wikipedia/commons/0/08/Moscow_Kremlin_1.jpg", lat: 55.7520, lng: 37.6175 },
  { n: "Mount Kilimanjaro", c: "Tanzania", i: "https://upload.wikimedia.org/wikipedia/commons/6/6b/Mt._Kilimanjaro_12.2006.jpg", lat: -3.0674, lng: 37.3556 },
  { n: "Iguazu Falls", c: "Argentina", i: "https://upload.wikimedia.org/wikipedia/commons/b/b5/Iguazu_Falls_from_the_Argentine_side.jpg", lat: -25.6953, lng: -54.4367 },
  { n: "Hagia Sophia", c: "Turkey", i: "https://upload.wikimedia.org/wikipedia/commons/2/22/Hagia_Sophia_Mars_2013.jpg", lat: 41.0082, lng: 28.9784 },
  { n: "Burj Al Arab", c: "UAE", i: "https://upload.wikimedia.org/wikipedia/commons/b/b5/Burj_Al_Arab_2.jpg", lat: 25.1412, lng: 55.1853 },
  { n: "Mount Rushmore", c: "United States", i: "https://upload.wikimedia.org/wikipedia/commons/1/10/Mount_Rushmore_National_Memorial.jpg", lat: 43.8791, lng: -103.4591 },
  { n: "Alcatraz", c: "United States", i: "https://upload.wikimedia.org/wikipedia/commons/0/00/Alcatraz_Island_photo.jpg", lat: 37.8270, lng: -122.4230 },
  { n: "St. Peter's Basilica", c: "Vatican City", i: "https://upload.wikimedia.org/wikipedia/commons/f/f5/Basilica_di_San_Pietro_in_Vaticano_September_2015-1a.jpg", lat: 41.9022, lng: 12.4539 },
  { n: "Tower Bridge", c: "United Kingdom", i: "https://upload.wikimedia.org/wikipedia/commons/6/63/Tower_Bridge_from_Shad_Thames.jpg", lat: 51.5055, lng: -0.0754 },
  { n: "Golden Temple", c: "India", i: "https://upload.wikimedia.org/wikipedia/commons/9/91/Golden_Temple_India.jpg", lat: 31.6200, lng: 74.8765 },
  { n: "Potala Palace", c: "China", i: "https://upload.wikimedia.org/wikipedia/commons/9/97/Potala_Palace_in_Lhasa.jpg", lat: 29.6580, lng: 91.1186 },
  { n: "Louvre", c: "France", i: "https://upload.wikimedia.org/wikipedia/commons/6/66/Louvre_Museum_Wikimedia_Commons.jpg", lat: 48.8606, lng: 2.3376 },
  { n: "Forbidden City", c: "China", i: "https://upload.wikimedia.org/wikipedia/commons/5/52/Forbidden_City_Beijing.jpg", lat: 39.9163, lng: 116.3972 },
  { n: "Bran Castle", c: "Romania", i: "https://upload.wikimedia.org/wikipedia/commons/c/cd/Bran_Castle.jpg", lat: 45.5149, lng: 25.3672 },
  { n: "Mont Saint-Michel", c: "France", i: "https://upload.wikimedia.org/wikipedia/commons/7/70/Mont_St_Michel_3.jpg", lat: 48.6361, lng: -1.5115 },
  { n: "Versailles", c: "France", i: "https://upload.wikimedia.org/wikipedia/commons/f/f1/Chateau_de_Versailles_1722_Pierre_Denis_Martin.jpg", lat: 48.8049, lng: 2.1204 },
  { n: "Edinburgh Castle", c: "United Kingdom", i: "https://upload.wikimedia.org/wikipedia/commons/c/c5/Edinburgh_Castle_from_the_Vennel.jpg", lat: 55.9486, lng: -3.1999 },
  { n: "Buckingham Palace", c: "United Kingdom", i: "https://upload.wikimedia.org/wikipedia/commons/d/d3/Buckingham_Palace_aerial_view_2016_%28cropped%29.jpg", lat: 51.5014, lng: -0.1419 },
  { n: "Uluru", c: "Australia", i: "https://upload.wikimedia.org/wikipedia/commons/3/3e/Uluru_sunset.jpg", lat: -25.3444, lng: 131.0369 },
  { n: "Blue Mosque", c: "Turkey", i: "https://upload.wikimedia.org/wikipedia/commons/3/36/Sultan_Ahmed_Mosque_Istanbul.jpg", lat: 41.0054, lng: 28.9768 },
  { n: "Banaue Rice Terraces", c: "Philippines", i: "https://upload.wikimedia.org/wikipedia/commons/2/29/Banaue_Rice_Terraces.jpg", lat: 16.9200, lng: 121.0500 },
  { n: "Galapagos Islands", c: "Ecuador", i: "https://upload.wikimedia.org/wikipedia/commons/6/66/Galapagos_Islands_beach.jpg", lat: -0.8293, lng: -90.9821 },
  { n: "Matterhorn", c: "Switzerland", i: "https://upload.wikimedia.org/wikipedia/commons/6/68/Matterhorn_from_Domh%C3%BCtte_-_2.jpg", lat: 45.9763, lng: 7.6583 },
  { n: "Yosemite Valley", c: "United States", i: "https://upload.wikimedia.org/wikipedia/commons/d/d6/Yosemite_Valley_from_Wawona_Tunnel_view.jpg", lat: 37.7456, lng: -119.5936 }
];
...
BASE_50_PHOTOS.forEach((p, idx) => {
  for (let i = 0; i < 10; i++) {
    PHOTOGUESSR_POOL.push({
      ...
      clue: "Pinpoint this globally famous landmark sector."
    });
  }
});

// ============================================================================
// 3. EXACTLY 500 TRIVIA KNOWLEDGE BASE (416 Generated + 84 Hardcoded)
// ============================================================================
const RAW_84_TRIVIA = [
